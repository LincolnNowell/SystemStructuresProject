        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="name-location">
                    ...
                    <button type="button" class="btn maroon-style"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
